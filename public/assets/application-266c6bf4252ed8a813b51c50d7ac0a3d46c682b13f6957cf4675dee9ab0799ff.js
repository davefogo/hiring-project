...
(function() {
  ...
  $(function() {
    ...
    now = Date.now();
    $.ajax({
      url: 'http://api.worldweatheronline.com/premium/v1/past-weather.ashx?key=ad674fc16aef4b48811103245203006&q=30.404251,-97.849442&format=json&date=2020-06-01&enddate=2020-06-30&tp=1&callback=?',
      dataType: 'jsonp',
      async: false,
      success: function(data) {
        ...
        weatherForAustin = Highcharts.stockChart('container', {
          ...
          $.ajax({
            url: 'http://api.worldweatheronline.com/premium/v1/weather.ashx?key=ad674fc16aef4b48811103245203006&q=30.404251,-97.849442&format=json&num_of_days=2&tp=1&callback=?',
            dataType: 'jsonp',
            async: false,
