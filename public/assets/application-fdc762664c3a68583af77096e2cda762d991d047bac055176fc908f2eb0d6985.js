...
(function() {
  ...
  $(function() {
    ...
    $.ajax({
      url: 'https://api.worldweatheronline.com/premium/v1/past-weather.ashx?key=ad674fc16aef4b48811103245203006&q=30.404251,-97.849442&format=json&date=2020-06-01&enddate=2020-06-30&tp=3&callback=?',
      dataType: 'jsonp',
      async: false,
    ...
    setInterval((function() {
      ...
      now = Date.now();
      $.ajax({
        url: 'https://api.worldweatheronline.com/premium/v1/past-weather.ashx?key=&q=30.404251,-97.849442&format=json&date=2020-06-01&enddate=2020-06-30&tp=1&callback=?',
        dataType: 'jsonp',
        async: false,
        success: function(data) {
          ...
          weatherForAustin = Highcharts.stockChart('container', {
            ...
            $.ajax({
              url: 'https://api.worldweatheronline.com/premium/v1/weather.ashx?key=&q=30.404251,-97.849442&format=json&num_of_days=2&tp=1&callback=?',
              dataType: 'jsonp',
              async: false,
              success: function(data2) {
                var days;
      ...
      $.ajax({
        ...
        async: false,
        success: function(data3) {
          var dataArray3, date, dateTime, day, days, hourlyTemps, hours, i, j, temp, time, unixTime, unixTimeCST, weatherForAustin2;
          dataArray3 = [];
          days = data3.data.weather;
          i = 0;
          while (i < days.length) {
              ...
              success: function(data4) {
                ...
                while (i < days.length) {
                  ...
                  while (j < hourlyTemps.length) {
                    ...
                    unixTimeCST = unixTime - UTCOffset;
                    temp = parseInt(hours.tempF);
                    dataArray4.push([unixTimeCST, temp]);
                    j++;
                  }
                  i++;
                }
